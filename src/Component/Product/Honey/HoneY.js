...
const HoneY = (props) => {
  ...
  let page_Items=add_Items // Менять
  let [item_1,dict_1,item_2,dict_2,item_3,dict_3,item_4,dict_4]=[Tea[0],TeaDict,Honey[0],HoneyDict,Oil[0],OilDict,Addings[0],AddDict] // Менять
  let pWay=props.honey// менять
